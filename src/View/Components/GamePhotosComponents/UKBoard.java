...
public class UKBoard implements BoardGetterFunctionality {
        ...
        return new ArrayList<>() {
            {
                ...
                add(new ImageIcon(this.getClass().getResource("/Monopoly_Images_UK/LEFT/COMMUNITY_CHEST2.png"))
                        .getImage());
        ...
        return new ArrayList<>() {
            {
                ...
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/LIGHT_BLUE3.png")))
                        .getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/LIGHT_BLUE2.png")))
                        .getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/CHANCE1.png"))).getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/LIGHT_BLUE1.png")))
                        .getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/RAILROAD1.png")))
                        .getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/INCOME_TAX.png")))
                        .getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/BROWN2.png"))).getImage());
                add(new ImageIcon((this.getClass().getResource("/Monopoly_Images_UK/BOTTOM/COMMUNITY_CHEST1.png")))
                        .getImage());
    ...
    public ArrayList<Image> getRightPhotos() {
        return new ArrayList<>() {
            {
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/GREEN1.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/GREEN2.png")))
                        .getImage());
                add(new ImageIcon(Objects
                        .requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/COMMUNITY_CHEST3.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/GREEN3.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/RAILROAD4.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/CHANCE3.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/DARK_BLUE1.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/LUXURY_TAX.png")))
                        .getImage());
                add(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/Monopoly_Images_UK/RIGHT/DARK_BLUE2.png")))
                        .getImage());
            }
        };
    }
